...
DWORD WINAPI instance_thread(LPVOID); 
...
// client connections.
DWORD WINAPI instance_thread(LPVOID lpvParam) { 
...
VOID get_answer_to_request(LPTSTR pchRequest, LPTSTR pchReply, LPDWORD pchBytes) {
